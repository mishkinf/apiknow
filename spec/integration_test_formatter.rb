...
class IntegrationTestFormatter < RSpec::Core::Formatters::BaseTextFormatter
  ...
  def example_started(proxy)
    ...
    route = proxy.options[:route]
    @output << "#{route.http_method.upcase} #{route.path}\n" if route
    @output << "\n"
  end
end
...
#end
#
#IntegrationTestFormatter = Class.new(parent_class) do
#  include rspec_module
#
#  def dump_progress
#    output.print "Mishkin is amazing"
#  end
#end
#
#  ESC      = "\e["
